...
namespace Travel_Company.WPF.Migrations
{
    ...
    [Migration("20231101112139_AddPenaltyDescription")]
    partial class AddPenaltyDescription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Travel_Company.WPF.Models.Penalty", b =>
                {
                    ...
                    b.Property<DateTime>("CompensationDateTime")
                        .HasColumnType("TEXT");

                    b.Property<string>("CompensationDescription")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Travel_Company.WPF.Models.Users.Object", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Travel_Company.WPF.Models.Users.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Travel_Company.WPF.Models.Users.UserObject", b =>
                {
                    ...
                    b.ToTable("UsersObjects", (string)null);
                });
            ...
            modelBuilder.Entity("Travel_Company.WPF.Models.Users.UserObject", b =>
                {
                    b.HasOne("Travel_Company.WPF.Models.Users.Object", "Object")
                        .WithMany("UsersObjects")
                        .HasForeignKey("ObjectId")
                        .IsRequired()
                        .HasConstraintName("FK_UsersObjects_Objects");

                    b.HasOne("Travel_Company.WPF.Models.Users.User", "User")
                        .WithMany("UsersObjects")
